...
| `/waypoints` | `app/waypoints/` | Every Name in the Sky — all 69k FAA waypoints as a canvas constellation of the US, searchable (static JSON, no storage) |
